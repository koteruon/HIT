...
_C.MODEL.ACTION_DETECTOR = CN()
_C.MODEL.ACTION_DETECTOR.STRUCTURE = "ActionDetector"

_C.MODEL.COMBINED_3D_ROIHEADS = CN()
_C.MODEL.COMBINED_3D_ROIHEADS.STRUCTURE = "Combined3dROIHeads"

_C.MODEL.ROIActionHead = CN()
_C.MODEL.ROIActionHead.STRUCTURE = "ROIActionHead"
