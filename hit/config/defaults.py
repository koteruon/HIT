...
_C.MODEL.SKATEFORMER = CN()
_C.MODEL.SKATEFORMER.num_classes = 8
_C.MODEL.SKATEFORMER.num_people = 1
_C.MODEL.SKATEFORMER.num_points = 16
_C.MODEL.SKATEFORMER.kernel_size = 7
_C.MODEL.SKATEFORMER.num_heads = 32
_C.MODEL.SKATEFORMER.attn_drop = 0.5
_C.MODEL.SKATEFORMER.head_drop = 0.0
_C.MODEL.SKATEFORMER.rel = True
_C.MODEL.SKATEFORMER.drop_path = 0.2
_C.MODEL.SKATEFORMER.type_1_size = [4, 4]
_C.MODEL.SKATEFORMER.type_2_size = [4, 8]
_C.MODEL.SKATEFORMER.type_3_size = [4, 4]
_C.MODEL.SKATEFORMER.type_4_size = [4, 8]
_C.MODEL.SKATEFORMER.mlp_ratio = 4.0
_C.MODEL.SKATEFORMER.index_t = True
...
_C.SOLVER.TARGET_EVAL_MAP = -1.0
_C.SOLVER.IS_CHECK_F1_SCORE = False
_C.SOLVER.CHECK_F1_SCORE_TARGET = []
_C.SOLVER.START_EVAL_PERIOD = -1
