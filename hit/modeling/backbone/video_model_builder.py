...
class SlowFast(nn.Module):
    ...
    def _construct_network(self, cfg):
        ...
        out_dim_ratio = cfg.MODEL.BACKBONE.SLOWFAST.BETA_INV // cfg.MODEL.BACKBONE.SLOWFAST.FUSION_CONV_CHANNEL_RATIO
...
class ViT(nn.Module):
    ...
    def forward(self, slow_x, fast_x):
        ...
        if self.pos_embed.shape[1] != ws[0] * ws[1] * ws[2]:
            ...
            pos_embed = interpolate_pos_embed_online(pos_embed, self.grid_size, [ws[1], ws[2]], 0).reshape(1, -1, C)
