...
CONFIG_FILE="./config_files/hitnet_skateformer.yaml"
...
do
  ...
  sed -i "s|OUTPUT_DIR: .*|OUTPUT_DIR: \"data/output/hitnet_pose_transformer_with_skateformer_20250319_seed_${OUTPUT_NUM}\"|" "$CONFIG_FILE"
