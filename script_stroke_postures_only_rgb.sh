...
CONFIG_FILE="./config_files/hitnet_stroke_postures_j_only_rgb.yaml"
...
do
  ...
  sed -i "s|OUTPUT_DIR: .*|OUTPUT_DIR: \"data/output/hitnet_pose_transformer_stroke_postures_joint_only_rgb_20250511_seed_${OUTPUT_NUM}\"|" "$CONFIG_FILE"
